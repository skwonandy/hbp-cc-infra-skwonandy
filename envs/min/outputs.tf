...
# min では Batch を使用しないため output なし
...
output "ecr_worker_url" {
  description = "ECR repository URL for worker (null in min; worker is not deployed)"
...
output "github_actions_deploy_role_arn" {
  description = "Register this as AWS_DEPLOY_ROLE_ARN in GitHub Environment 'min' secrets"
